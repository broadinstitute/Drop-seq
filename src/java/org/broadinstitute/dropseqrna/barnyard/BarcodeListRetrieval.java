...
public class BarcodeListRetrieval {
	 ...
	 * @return
	 */
	public List<String> getCellBarcodes(File bamFile, String cellBarcodeTag, String molecularBarcodeTag, 
			String geneExonBarcodeTag, String strandTag, File cellBCFile, Integer readQuality, Integer minNumTranscriptsPerCell, 
			Integer minNumNumGenesPerCell, Integer minNumReadsPerCell, Integer numCoreBarcodes, Integer editDistance, Integer minNumReadsMolBarcode, boolean useStrandInfo) {
	...
	public boolean validateGetCellBarcodeListParams(File bamFile, String cellBarcodeTag, String molecularBarcodeTag, 
			String geneBarcodeTag, String exonTag, File cellBCFile, Integer readQuality, Integer minNumTranscriptsPerCell, 
			Integer minNumNumGenesPerCell, Integer minNumReadsPerCell, Integer numCoreBarcodes) {
